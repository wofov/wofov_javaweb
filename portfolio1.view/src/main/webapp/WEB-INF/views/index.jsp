...
<%@ include file="./top.jsp" %><!-- 최상단 배너, 대메뉴,회원가입, 로그인 -->
</div>
<div class="sliderA wide_visual_slider">
<%@ include file="./banner.jsp" %><!-- 배너출력파트 -->
</div>
<div class="resp_wrap display_wrap">
<%@ include file="./collection.jsp" %><!-- md 추천 상품 리스트 12개 -->
</div>
<br/>
<br/>
<br/>
<div class="full_bnr">
<%@ include file="./av.jsp" %><!-- 메인페이지 신규 상품 홍보 부분 -->
</div>
<div class="full_bnr2">
<%@ include file="./av2.jsp" %><!-- 메인 및 서브페이지 홍보 상품 부분 -->
</div>
<div id="layout_footer" class="layout_footer">
<%@ include file="./footer.jsp" %><!-- 쇼핑몰 정보 출력 및 카피라이터 -->
</div></div>
